      ...
      <PageHeader
        ...
        action={
          <div className="flex flex-wrap items-center gap-2">
            ...
            {editable && <Link href="/web-store/groups" className="rounded-md border border-neutral-300 bg-white px-3 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50">Groups</Link>}
