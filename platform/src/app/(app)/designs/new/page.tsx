...
export default async function NewDesignItemPage({ searchParams }: { searchParams: Promise<{ err?: string }> }) {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <PageHeader title="New design" description="Compose the item number from customer + design base + suffix, attach the art, and it becomes an orderable inventory item." />
