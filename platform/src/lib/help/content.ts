...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { k: "img", src: "crm-new.png", caption: "The new Business Partner form — with the \"Scan a business card\" tool at the top." },
      { k: "h", text: "Scan a business card (optional)" },
      { k: "p", text: "On a phone or tablet, use \"📇 Scan a business card\" at the top of the form: snap the card and MakeReady reads it (company, contact, phone, email, address) and fills the form for you to review before saving. Great for turning a stack of cards from the road into leads. (Needs the AI key configured; otherwise just fill the form manually.)" },
      {
        k: "steps",
        items: [
  ...
  // ─────────────────────────────── Sales ─────────────────────────────────────
  {
    ...
    section: "Sales",
    summary: "Build a quote in the Garments & Decoration builder — pick garments, sizes, decoration and extras, and it prices automatically from the softgoods pricing engine.",
    who: "Admin, Sales Manager, Sales Rep",
    blocks: [
      { k: "p", text: "Quotes are built in one place: the Garments & Decoration builder. There's no separate \"line items\" list anymore — every line is a garment. Open Sales → Quotes → \"New quote\", pick the customer and a product template, and click \"Create & open builder\"." },
      {
        k: "steps",
        items: [
          ...
          { text: "Click \"+ Add garment\". In the Garment box, type to search the full catalog by name, brand, or style number and pick the blank. Choose a Color (a standard palette is offered for every garment).", img: "quote-builder.png", caption: "The Quote Builder — search the catalog, add sizes, decoration, and extras; it prices itself." },
          { text: "Enter quantities on the size grid. 2XL / 3XL upcharges are added automatically." },
          { text: "Click \"+ Add decoration\" for each print or embroidery location. Choose the location (full front, left chest, sleeve…) and method (Silk Screen, Embroidery, DTF). For silk screen, set the print level A / B / C (the design's screen-color class) — this drives the price. For embroidery, set the stitch tier." },
          { text: "Tick any Extras for the garment — barcode, folding, hang tags, name drop, etc. Each is priced per piece by the engine." },
          { text: "The line shows its price with a green \"engine\" badge when it's priced by the softgoods engine. Add as many garments as the job needs, then Save quote.", img: "quote-attachments.png", caption: "Attach customer-provided art on the quote — it carries to the order and the art department automatically." },
        ],
      },
      { k: "tip", text: "Images you attach under \"Customer artwork & reference images\" are copied onto the order when the quote is converted, so the art department has exactly what the customer sent — no re-uploading." },
      { k: "h", text: "How pricing works" },
      { k: "p", text: "Decorated garments price through the softgoods pricing engine — the same math as G54's \"Softgood Pricing Calculator\" workbook, now built into the app and verified to the cent." },
      {
        k: "list",
        items: [
          "Per-piece price = garment cost × the quantity-band multiplier + the screen charge for the print level (A/B/C) + size upcharges (2XL/3XL) + any extras.",
          "Quantity bands: the unit price drops as the quantity rises (48 / 72 / 144 / 288 / …); the engine picks the band for the quantity you enter.",
          "Extras like barcode ($0.15), folding, and hang tags add per piece; vendor freight and artist royalties are applied automatically when they apply.",
          "Customer tiers (HV / MV) and reorder rules are handled by the engine.",
          "Pricing is locked down: reps can't change the price or discount — only a Sales Manager or Admin can discount.",
          "The server recalculates every total on save, so the numbers are always authoritative.",
        ],
      },
      { k: "tip", text: "Need a quick standalone estimate? The \"Softgoods price check\" tool on the quote page prices any garment #, level, quantity and extras without adding a line." },
      { k: "tip", text: "Garment costs are managed by an admin under Admin → Softgoods Pricing → Garments & costs; the blank catalog reps pick from lives under Admin → Catalog & Pricing. See Softgoods pricing and Catalog & pricing." },
    ],
    related: ["softgoods-pricing", "quoting-for-reps", "editing-and-emailing-a-quote", "catalog-and-pricing", "orders-and-production-stages"],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      { k: "h", text: "Email for approval" },
      { k: "p", text: "There's a single send button — \"✉ Email for approval\". It emails the customer (through the platform) a secure link to review the quote and Approve or Decline online. Sending advances a Draft to Sent and logs it to the customer's CRM history." },
      {
        k: "steps",
        items: [
          { text: "Click \"✉ Email for approval\". The customer's primary contact (or account email) gets a message with an approve/decline link." },
          { text: "The customer reviews and clicks Approve or Decline on their own page — no login required. Their decision is captured in the system." },
          { text: "On Approve, the quote can convert straight into a trackable order (subject to credit review)." },
        ],
      },
      { k: "tip", text: "Prefer to send the link yourself? The \"Customer approval\" section on the quote shows the same public link to copy and paste. Everything stays in-system — there's no \"email from your own inbox\" option anymore, so nothing slips past the CRM history." },
    ],
  ...
  // ─────────────────────────────── Art & Production ──────────────────────────
  {
    ...
    blocks: [
      ...
      { k: "img", src: "production-board.png", caption: "The production board — drag jobs across the columns; a \"Press check\" badge flags jobs awaiting first-article sign-off." },
      {
        k: "list",
        items: [
      ...
      { k: "img", src: "production-job.png", caption: "The job page: capture the first-article photo, see the spec and artwork, and set status." },
      ...
      { k: "tip", text: "This replaces texting a photo from a personal phone — the sign-off is now logged, tied to the job, and auditable. When SMS is enabled, art reviewers can also get a text with a link." },
      { k: "h", text: "The shop-floor schedule & ship calendar" },
      ...
      { k: "p", text: "The same page holds the Ship calendar — Ops publishes the dates the shop can ship on (add single dates or bulk-add weekdays over a range, with an optional daily cap). Orders then pick their committed ship date from this list on the order's Fulfillment card, instead of anyone free-typing a date." },
      { k: "img", src: "production-schedule.png", caption: "The shop-floor schedule with the Ops-managed ship calendar." },
  ...
  // ─────────────────────────────── Catalog & pricing (admin) ─────────────────
  {
    ...
    who: "Admin only",
    blocks: [
      { k: "p", text: "Admin → Catalog & Pricing is where the blank-garment catalog reps pick from lives. The full softgoods catalog (800+ garments) is already imported. Garment costs themselves are managed separately in Admin → Softgoods Pricing → Garments & costs — see Softgoods pricing." },
      { k: "img", src: "catalog.png", caption: "The garment catalog — search by name, brand or style #, page through, and edit any style." },
      { k: "h", text: "The garment catalog" },
      {
        k: "steps",
        items: [
          { text: "Search the catalog by name, brand, or style number (it's paginated for the 800+ blanks). Add a new style with its brand, style number, category, base sell price, and size class." },
          { text: "Open a style to add its colors. Every garment also gets a standard color palette in the Quote Builder automatically; colors you add here override it for that style. Tag each with a tier (white / light / dark)." },
          { text: "Mark styles or colors inactive to hide them from the Quote Builder without deleting history." },
        ],
      },
      { k: "tip", text: "A garment's cost (what the engine prices from) is matched by style number to Softgoods Pricing → Garments & costs — edit the cost there, not here." },
    ...
    related: ["softgoods-pricing", "building-a-quote", "order-templates"],
  },
  {
    slug: "softgoods-pricing",
    title: "Softgoods pricing (the pricing engine)",
    section: "Administration",
    summary: "Manage garment costs, extras, vendor freight, and royalties — the live engine that prices every decorated garment, replacing the Softgood Pricing Calculator spreadsheet.",
    who: "Admin only",
    blocks: [
      { k: "p", text: "Admin → Softgoods Pricing is the live pricing engine — reverse-engineered from G54's \"Version 11 Softgood Pricing Calculator\" workbook and verified to the cent. It prices every decorated garment in the Quote Builder. It has five tabs." },
      { k: "img", src: "pricing-calculator.png", caption: "Softgoods Pricing → Calculator: price any garment, level, quantity and extras live (silk screen, embroidery, ASI, and DTF)." },
      { k: "h", text: "Calculator" },
      { k: "p", text: "A live price check: pick a method (Silkscreen / Embroidery / ASI), enter a garment number (or a cost), quantity, print level (A/B/C) or stitch count, tier, extras, freight and royalty — and see the per-piece price with a full breakdown. There's also a DTF transfer widget that sizes the film layout and returns a per-piece surcharge." },
      { k: "h", text: "Garments & costs" },
      { k: "p", text: "The single source of truth for garment cost. Search any of the 800+ garments, edit its cost inline, or add a new one. This is what the Quote Builder prices from (matched to catalog styles by style number), so a cost change here flows straight into new quotes." },
      { k: "img", src: "pricing-garments.png", caption: "Garments & costs — search and edit the cost the engine prices from." },
      { k: "h", text: "Extras, Vendor freight & Royalties" },
      {
        k: "list",
        items: [
          "Extras — barcode, folding, hang tags, name drop, etc., each with a per-piece amount reps can add to a garment line.",
          "Vendor freight — per-vendor rules (e.g. free freight over a cost threshold, otherwise a per-garment add), applied automatically.",
          "Royalties — artist royalty percentages added on top of the decorated price when a design carries one.",
        ],
      },
      { k: "tip", text: "The quantity-band multiplier tables and A/B/C size upcharges are seeded from the workbook and stored as engine config (not editable in the UI yet). Ask to have a tab added if you need to adjust those directly." },
    ],
    related: ["building-a-quote", "catalog-and-pricing"],
  },
  ...
  // ─────────────────────────────── Accounting ────────────────────────────────
  {
    ...
    related: ["invoicing-and-payments", "accounts-payable", "landed-cost"],
  },
  {
    slug: "landed-cost",
    title: "Landed cost (freight spreading)",
    section: "Accounting",
    order: 7,
    summary: "Spread a shipment's freight and duty across its items so each item's cost reflects true landed cost, and post it to the GL.",
    who: "Admin, Finance",
    blocks: [
      { k: "p", text: "When goods arrive from a vendor, the freight (ocean/LCL, duty, brokerage) is a real part of what each item cost you. Accounting → Landed Cost spreads those charges across the shipment so each item's cost is its true landed cost — base cost plus its share of freight — instead of just the PO price." },
      { k: "h", text: "Building a landed-cost sheet" },
      { k: "steps", items: [
        { text: "Accounting → Landed Cost → “New landed-cost sheet”." },
        { text: "Enter the shipment: freight company, container/BOL reference, the freight amount, and any other charges (duty, brokerage) with a label." },
        { text: "Add each item on the shipment. Type the SKU — it auto-fills the item name and its current cost. Enter the quantity received. (Base cost pre-fills but you can override it.)" },
      ...
      { k: "h", text: "Items not in the catalog" },
      { k: "p", text: "If a line's SKU doesn't match an inventory item, it shows as “unmatched” and a banner tells you how much freight is affected. You can still apply the sheet — the unmatched freight is expensed to COGS (freight-in) rather than capitalized into inventory, so the clearing account still nets to zero and nothing is left dangling. To capitalize that freight instead, enter a valid SKU so the line matches an item." },
      { k: "warn", text: "Apply is one-way — it freezes the sheet and revalues costs. Double-check the items and charges first. Only matched lines change an item's cost." },
      { k: "h", text: "Rolling landed average (fixing the “average back to 2008” problem)" },
      { k: "p", text: "Every inventory item shows a rolling 365-day landed average with a year-over-year comparison, computed from applied landed-cost sheets — so you see recent, seasonally-relevant costs and tariff swings, not an all-time average dragged down by years-old data." },
    ],
    related: ["general-ledger", "accounts-payable", "inventory-overview"],
  },
  {
