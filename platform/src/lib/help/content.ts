...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { k: "h", text: "Suffixes — product, location & size" },
      { k: "p", text: "Suffixes come after the base. There are three kinds (the full list lives in Design settings):" },
      { k: "list", items: [
        "Softgood print location — Left Chest LC, Left Sleeve LS, Left Side LSD, Right Sleeve RS, Right Side RSD, Motif MF, Yoke YK, Full Front/Back Namedrop FFN/FBN. Only one print location? No suffix. A secondary location gets its own numbered line, listed by that secondary design.",
        "Hardgood product — Mug M, Koozie KZ, Ornament O, Pen PE, Pin PN, Patch P, Water Bottle W, Magnet MG, Tumbler T, Decal D, Key Chain K, and ~40 more.",
        "Size — Baby (Infant) B, Toddler T, Youth Y, Adult = no suffix; Baby/Toddler together BT, Youth/Adult together AY (the art is sized to the smallest garment).",
      ] },
